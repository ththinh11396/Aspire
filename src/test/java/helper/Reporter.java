...
public class Reporter {
    ...
    public static void createNote(String testNode){
        extentNode = extentTest.createNode(testNode).pass("pass");
    }
    ...
    public static void createGivenNote(String testGivenNode){
        extentNode = extentScenario.createNode(Given.class,"Given : "+testGivenNode).pass("pass");
    }
    public static void createWhenNote(String testWhenNode){
        extentNode = extentScenario.createNode(When.class,"When : "+testWhenNode).pass("pass");
    }
    public static void createThenNote(String testThenNode){
        extentNode = extentScenario.createNode(Then.class,"Then : "+testThenNode).pass("pass");
    }
